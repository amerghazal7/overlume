...
| Hybrid-vs-CUDA visual parity | Task 5 (VM-094)'s golden (`docs/runbooks/hybrid-golden-vm094.md`) | **APPROVED 2026-09-11** (fair parity package + d7c0c80 golden, user verdict) |
