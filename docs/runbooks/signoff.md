...
| Item | Owner | Status |
|---|---|---|
| Bowl-vs-CUDA visual parity | Task 2 (VM-091)'s golden (`docs/runbooks/bowl-golden-vm091.md`) + a live side-by-side | **APPROVED 2026-09-11** (fair parity package, user verdict) |
| Hybrid-vs-CUDA visual parity | Task 5 (VM-094)'s golden (`docs/runbooks/hybrid-golden-vm094.md`) | **APPROVED 2026-09-11** (fair parity package + 362cb89 golden, user verdict) |
