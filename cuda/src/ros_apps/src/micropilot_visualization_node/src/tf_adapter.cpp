...
mpviz::EgoState TfAdapter::update()
{
    mpviz::EgoState ego{};  // valid = 0 unless a lookup below succeeds
    ...
    const mpviz::Vec3 pos{t.transform.translation.x, t.transform.translation.y,
