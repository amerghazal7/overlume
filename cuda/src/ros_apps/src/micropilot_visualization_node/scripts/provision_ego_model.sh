...
# package's own directory (cuda/src/ros_apps/src/micropilot_visualization_node
# -> cuda/src/libs/visual_renderer).
CONVERTER="$PKG_DIR/../../../libs/visual_renderer/scripts/obj2gltf_m02p.py"
