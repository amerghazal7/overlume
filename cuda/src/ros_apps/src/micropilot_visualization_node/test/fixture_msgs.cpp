...
{
#ifndef MPVIZ_NODE_FIXTURES_DIR
#error "MPVIZ_NODE_FIXTURES_DIR not defined -- see CMakeLists.txt's mpviz_node_test_paths"
#endif
    return std::string(MPVIZ_NODE_FIXTURES_DIR) + "/" + fixture_name;
}
...
#error "TEST_CONFIG_DIR not defined -- see CMakeLists.txt's mpviz_node_test_paths"
#endif
