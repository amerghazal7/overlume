 ...
 *  all live in visualization_node.cpp (Task 5 Step 3's "wire the node
 ...
 *
 *  Reuses Task 2's mpviz::bowl::ProjectToCameraUv (bowl_projection.hpp) --
...
// mpviz::bowl::ProjectToCameraUv (Task 2); the FIRST camera whose UV lands
