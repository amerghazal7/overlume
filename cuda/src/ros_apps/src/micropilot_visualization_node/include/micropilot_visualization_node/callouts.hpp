 ...
 *     Formats it as "<n.n> m" and projects it via mpviz::project_to_screen()
 *     against the camera state the most recent mpviz::render_frame() call
...
// mpviz::get_hud_colors() already returns for the HUD's own accent, reused
