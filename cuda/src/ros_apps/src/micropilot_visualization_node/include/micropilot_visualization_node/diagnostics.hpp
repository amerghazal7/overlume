 ...
 *  the node's own `render_ms` (visualization_node.cpp's timer_callback()).
 *
 ...
 *  mirrors visualization_node.cpp's own `msgs == 0` guard (its
...
// caller-computed (visualization_node.cpp already has sim_clock_sec_ and the
