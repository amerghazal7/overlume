 ...
 *  subscription -- visualization_node.cpp owns create_subscription() and
 ...
 *  adapter has no hard-cutoff logic of its own -- visualization_node.cpp
...
private:
    struct StoredElement
    {
        ...
        mpviz::MapKind kind{mpviz::MapKind::OTHER};  // from the matched NsRule
