...
public:
    ...
    void fill(micropilot::visualization_app::SceneAssembly& out, double sim_time_sec);
...
private:
    ...
    std::vector<mpviz::Vec3> point_storage_;
    std::vector<mpviz::GenericMarker> axis_markers_;
    AdapterStats stats_;
};
