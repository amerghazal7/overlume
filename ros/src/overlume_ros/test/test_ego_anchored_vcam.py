...
Run (ROS + this repo's ros install sourced first):
    ...
    python3 ros/src/overlume_ros/test/test_ego_anchored_vcam.py
    ...
    class Fixture(Node):
        def __init__(self):
            ...
            self.create_subscription(
                Float64MultiArray, "/overlume_node/vcam_state", self._on_vcam, 10)
            self.create_subscription(
                Float64MultiArray, "/overlume_node/ego_state", self._on_ego, 10)
