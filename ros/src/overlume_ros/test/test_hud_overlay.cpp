...
// overlume::testing::render_and_compare (overlume/tests/golden.cpp).
...
// (Step 1's CMakeLists.txt comment) -- NOT overlume's, a different
...
// overlume/tests/golden.cpp's own block_ssim (not shared code --
