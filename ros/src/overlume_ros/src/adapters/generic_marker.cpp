...
bool HasNan(const overlume::Vec3& p) { return std::isnan(p.x) || std::isnan(p.y) || std::isnan(p.z); }
                                  ...
                                  double sim_time_sec)
{
    ...
    for (const auto& m : msg.markers)
    {
        ...
        switch (m.type)
        {
            case kTypeArrow: single_primitive = overlume::MarkerPrimitive::ARROW; break;
            case kTypeCube: single_primitive = overlume::MarkerPrimitive::CUBE; break;
            case kTypeSphere: single_primitive = overlume::MarkerPrimitive::SPHERE; break;
            case kTypeCylinder: single_primitive = overlume::MarkerPrimitive::CYLINDER; break;
            case kTypeLineStrip: single_primitive = overlume::MarkerPrimitive::LINE_STRIP; break;
            case kTypeLineList: single_primitive = overlume::MarkerPrimitive::LINE_LIST; break;
            case kTypePoints: single_primitive = overlume::MarkerPrimitive::POINTS; break;
            case kTypeTextViewFacing: single_primitive = overlume::MarkerPrimitive::TEXT; break;
            case kTypeMeshResource: single_primitive = overlume::MarkerPrimitive::MESH; break;
            case kTypeTriangleList: single_primitive = overlume::MarkerPrimitive::TRIANGLE_LIST; break;
            case kTypeCubeList:
        ...
        if (is_fan_out)
        {
            ...
            StoredMarker entry;
            entry.primitive =
                m.type == kTypeCubeList ? overlume::MarkerPrimitive::CUBE : overlume::MarkerPrimitive::SPHERE;
            ...
            primitive == overlume::MarkerPrimitive::TRIANGLE_LIST)
        {
            ...
            if ((primitive == overlume::MarkerPrimitive::TRIANGLE_LIST && m.points.size() % 3 != 0) ||
