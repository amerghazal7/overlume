...
OverlumeNode::CallbackReturn OverlumeNode::on_configure(const rclcpp_lifecycle::State& /*state*/) {
    ...
    // (overlume/CMakeLists.txt compiles THIS CHECKOUT's own absolute
    ...
    // render_mode_ field comment, overlume_node.hpp. Declare-time
...
// VM-040, overlume::set_quality() DOES apply a preset live at the library level,
